...
/**
 * This API retrieves the Flow Estimator Counter.
 *
 ...
 * @param[in] handle                     - SX-API handle
 * @param[in] profile_key                - flow estimator profile key
 * @param[out] profile_attr_p            - flow estimator profile attributes
 *
 * @return SX_STATUS_SUCCESS if operation completes successfully
 ...
 * @param [in] profile_filter_p      - Specify a filter parameter (not supported yet)
 * @param [out] profile_key_list_p   - return list of profile keys
 * @param [in,out] profile_key_cnt_p - [in] number of profile keys to get
